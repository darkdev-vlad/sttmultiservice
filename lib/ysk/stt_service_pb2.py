...
_STREAMINGRECOGNITIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='yandex.cloud.ai.stt.v2.StreamingRecognitionResponse.end_of_single_utterance', index=1,
...
_STREAMINGRECOGNITIONREQUEST.fields_by_name['config'].containing_oneof = _STREAMINGRECOGNITIONREQUEST.oneofs_by_name[
    'streaming_request']
_STREAMINGRECOGNITIONREQUEST.oneofs_by_name['streaming_request'].fields.append(
    _STREAMINGRECOGNITIONREQUEST.fields_by_name['audio_content'])
_STREAMINGRECOGNITIONREQUEST.fields_by_name['audio_content'].containing_oneof = \
_STREAMINGRECOGNITIONREQUEST.oneofs_by_name['streaming_request']
...
StreamingRecognitionRequest = _reflection.GeneratedProtocolMessageType('StreamingRecognitionRequest',
...
StreamingRecognitionResponse = _reflection.GeneratedProtocolMessageType('StreamingRecognitionResponse',
                                                                        (_message.Message,), dict(
...
SpeechRecognitionAlternative = _reflection.GeneratedProtocolMessageType('SpeechRecognitionAlternative',
                                                                        (_message.Message,), dict(
